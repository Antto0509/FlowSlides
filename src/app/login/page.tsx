    ...
    >
      ...
      <div className="text-center mb-8">
        <Link href="/" className="inline-flex items-center gap-2 group">
          <div className="w-9 h-9 rounded-4xl gradient-primary flex items-center justify-center shadow-lg shadow-primary/20">
...
export default function LoginPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4 relative overflow-hidden">
      ...
      <Suspense fallback={<div className="w-full max-w-sm h-96 rounded-2xl bg-card animate-pulse" />}>
        <LoginForm />
      </Suspense>
    </div>
  );
