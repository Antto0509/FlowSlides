...
import { Plan, FAQS, Subscription } from "@/types/pricing";
...
export function PricingClient({ plans, faqs, subscription }: PricingClientProps) {
    ...
    <>
      ...
      <section className="relative overflow-hidden pt-35 pb-16 px-4">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center space-y-6">
          ...
          {/* Billing toggle — masqué si abonnement actif */}
          ...
          {isSubscriptionActive && (
            ...
            >
              ✓ Tu es abonné au plan {planName(subscription!.plan.charAt(0).toUpperCase() + subscription!.plan.slice(1))}
            </motion.div>
          )}
        </div>
      </section>
            ...
            >
              <Link href="/create-carousel">
                <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
                  <Button size="lg" className="hero-cta-primary h-12 px-8 font-semibold border-0 gap-2">
              ...
              <Link href="/examples">
                <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
                  <Button size="lg" variant="outline" className="hero-cta-secondary h-12 px-8 font-semibold">
                    Voir des exemples
                  </Button>
                </motion.div>
              </Link>
